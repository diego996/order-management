    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-login">Effettua il login e restituisce un token.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-GETapi-user">
                                <a href="#authentication-GETapi-user">Restituisce i dati dell’utente autenticato.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-logout">
                                <a href="#authentication-POSTapi-logout">Revoca il token corrente.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-orders">Lista gli ordini con filtri.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-orders">
                                <a href="#endpoints-POSTapi-orders">Crea un nuovo ordine.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-orders--id-">
                                <a href="#endpoints-GETapi-orders--id-">Mostra i dettagli di un singolo ordine.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-orders--id-">
                                <a href="#endpoints-PUTapi-orders--id-">Aggiorna un ordine esistente.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-orders--id-">
                                <a href="#endpoints-DELETEapi-orders--id-">Elimina un ordine.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
        ...
        <h1 id="authentication">Authentication</h1>
                                ...
                                <h2 id="authentication-POSTapi-login">Effettua il login e restituisce un token.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Indirizzo email dell'utente. Example: <code>user@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Password dell'utente. Example: <code>secret</code></p>
        </div>
        </form>

                    <h2 id="authentication-GETapi-user">Restituisce i dati dell’utente autenticato.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTapi-logout">Revoca il token corrente.</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-GETapi-orders">Lista gli ordini con filtri.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/orders?customer_id=1&amp;status=pending&amp;date_from=2023-10-01&amp;date_to=2023-10-31&amp;per_page=15" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>Filtra per ID cliente. Example: <code>1</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>Filtra per stato (pending, completed). Example: <code>pending</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="date_from"                data-endpoint="GETapi-orders"
               value="2023-10-01"
               data-component="query">
    <br>
<p>date Filtra data inizio. Example: <code>2023-10-01</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="date_to"                data-endpoint="GETapi-orders"
               value="2023-10-31"
               data-component="query">
    <br>
<p>date Filtra data fine. Example: <code>2023-10-31</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>Numero di risultati per pagina. Example: <code>15</code></p>
            </div>
                </form>

                    <h2 id="endpoints-POSTapi-orders">Crea un nuovo ordine.</h2>
...
<div class="bash-example">
    ...
    \"user_id\": \"consequatur\",
    \"customer_id\": 1,
    \"order_date\": \"2025-05-07T15:00:48\",
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>ID cliente. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_date"                data-endpoint="POSTapi-orders"
               value="2025-05-07T15:00:48"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-05-07T15:00:48</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_code"                data-endpoint="POSTapi-orders"
               value="consequatur"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Stato ordine. Example: <code>pending</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
...
<small>string[]</small>&nbsp;
 &nbsp;
<br>
<p>Elenco prodotti con id e quantità.</p>
            </summary>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="products.0.product_id"                data-endpoint="POSTapi-orders"
               value="consequatur"
               data-component="body">
    <br>
...
<p>Must be at least 1. Example: <code>45</code></p>
                    ...
                    <h2 id="endpoints-GETapi-orders--id-">Mostra i dettagli di un singolo ordine.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID dell’ordine. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-PUTapi-orders--id-">Aggiorna un ordine esistente.</h2>
...
<code class="language-json" style="max-height: 300px;">{  restituzione ordine aggiornato  }</code>
 </pre>
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
...
<code class="language-json" style="max-height: 300px;">{  errore di validazione  }</code>
 </pre>
    </span>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>ID cliente. Example: <code>17</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>order_date</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_date"                data-endpoint="PUTapi-orders--id-"
               value="2025-05-07T15:00:48"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-05-07T15:00:48</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="order_code"                data-endpoint="PUTapi-orders--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Stato. Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="products.0.product_id"                data-endpoint="PUTapi-orders--id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="products.0.price"                data-endpoint="PUTapi-orders--id-"
               value="45"
               data-component="body">
    <br>
<p>This field is required when <code>products</code> is present. Must be at least 0. Example: <code>45</code></p>
                    </div>
                                    </details>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-orders--id-">Elimina un ordine.</h2>
